...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017F/SingleElectron/AOD/17Nov2017-v1/50000/005B2A56-96E0-E711-B727-0CC47A4D7690.root')
)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('TnPTree_data.root')
)
...
process.sc_sequence = cms.Sequence(process.sc_sequenceAOD+process.probeSC+process.probeSCEle)
...
process.tag_sequence = cms.Sequence(process.goodElectrons+process.tagEleCutBasedTight+process.tagEle)
