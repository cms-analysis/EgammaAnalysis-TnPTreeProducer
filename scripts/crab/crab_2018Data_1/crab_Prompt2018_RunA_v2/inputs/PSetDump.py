...
process.tnpPairs_sequence = cms.Sequence(process.tnpPairingEleIDs+process.tnpPairingPhoIDs)
...
process.tree_sequence = cms.Sequence(process.tnpEleIDs+process.tnpPhoIDs)
...
process.cand_sequence = cms.Sequence(process.init_sequence+process.tag_sequence+process.ele_sequence+process.pho_sequence)
