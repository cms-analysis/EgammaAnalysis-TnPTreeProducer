...
#== CMSSW:    [0] Processing  Event run: 1 lumi: 3690 event: 9222513 stream: 0
#== CMSSW:    [1] Running path 'p'
#== CMSSW:    [2] Calling method for module VpTFilter/'VpTFilter'
#== CMSSW: Exception Message:
#== CMSSW: Principal::getByToken: Found zero products matching all criteria
#== CMSSW: Looking for type: LHEEventProduct
#== CMSSW: Looking for module label: EvtHandle
#== CMSSW: Looking for productInstanceName:
#== CMSSW:
#== CMSSW:    Additional Info:
#== CMSSW:       [a] If you wish to continue processing events after a ProductNotFound exception,
#== CMSSW: add "SkipEvent = cms.untracked.vstring('ProductNotFound')" to the "options" PSet in the configuration.
#== CMSSW:
